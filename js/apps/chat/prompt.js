...
/* ==========================================================================
   [提示词区域 8-A][已按本次需求补充时间段划分] 强化时间感知
   说明：
...
10. 根据当前真实时间所属时间段创设更像真实人的聊天情景，并对不同时间段保持敏感：
...
12. 你看到的 \`[消息发送时间：...]\`、\`本轮 API 实际请求时间\`、\`最近一条聊天记录时间\` 等都只用于后台换算时间；最终回复里绝对禁止原样复述这些标注，也不要把它们裁剪成半截时间文本发出来。`);
}
