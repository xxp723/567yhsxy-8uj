...
/* ==========================================================================
   [区域标注·已完成·index.js入口拆分] 事件代理处理模块
   说明：
   1. 从 index.js 拆出点击、输入、变更、键盘、双击和 HTML 卡片交互事件处理。
   2. 入口 index.js 只负责绑定/解绑事件；本模块保持原业务分支顺序与持久化调用。
...
import { renderChatList, showAddChatModal } from './chat-list.js';
import {
  showAsideEnterModal,
...
import {
  ...
  refreshFavoriteSearchResultsOnly,
