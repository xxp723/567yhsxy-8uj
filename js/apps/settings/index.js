...
const ICONS = {
  ...
  chevronDown: `<svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" width="14" height="14"><path d="M36 18L24 30L12 18" stroke="currentColor" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/></svg>`,
  uploadLocal: `<svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" width="18" height="18"><path d="M24 8V28" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/><path d="M14 18L24 8L34 18" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/><path d="M10 38H38" stroke="currentColor" stroke-width="3" stroke-linecap="round"/><path d="M14 28V38H34V28" stroke="currentColor" stroke-width="3" stroke-linejoin="round"/></svg>`,
  link: `<svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" width="18" height="18"><path d="M19 25L29 15" stroke="currentColor" stroke-width="3" stroke-linecap="round"/><path d="M16 15H13C8.58172 15 5 18.5817 5 23C5 27.4183 8.58172 31 13 31H17" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/><path d="M32 17H35C39.4183 17 43 20.5817 43 25C43 29.4183 39.4183 33 35 33H31" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/></svg>`,
  selected: `<svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" width="16" height="16"><circle cx="24" cy="24" r="18" stroke="currentColor" stroke-width="3"/><path d="M17 24L22 29L32 19" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/></svg>`,
  unselected: `<svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" width="16" height="16"><circle cx="24" cy="24" r="18" stroke="currentColor" stroke-width="3"/></svg>`,
