...
export const MEMORY_ICONS = {
  ...
  check: '<svg viewBox="0 0 48 48" fill="none" aria-hidden="true"><path d="M40 14L21 33L10 22" stroke="currentColor" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/></svg>',
  ...
  summarize: '<svg viewBox="0 0 48 48" fill="none" aria-hidden="true"><path d="M8 8H40V40H8V8Z" stroke="currentColor" stroke-width="4" stroke-linejoin="round"/><path d="M16 17H32M16 25H28M16 33H24" stroke="currentColor" stroke-width="4" stroke-linecap="round"/><path d="M35 26L38 32L44 35L38 38L35 44L32 38L26 35L32 32L35 26Z" stroke="currentColor" stroke-width="3" stroke-linejoin="round"/></svg>',
...
/* ==========================================================================
   [区域标注·已完成·本次旧事记忆类型精简展示区]
   说明：
   1. 旧事当前只保留“长期记忆 / 重点长期 / 待确认”三类用户可见口径。
   2. “重点长期”仍由 longterm + isPermanent 表示；不再保留历史废弃类型展示入口，避免与现有重点长期口径冲突。
   3. 本区只维护类型文案与图标，不读写任何持久化数据。
   ========================================================================== */
