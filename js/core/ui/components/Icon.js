 ...
 * @param {Record<string, string>} [options.iconImages] - appId → 自定义图片 URL 映射
 */
export function createAppIcon(appMeta, options = {}) {
  ...
  const customImg = (options.iconImages && options.iconImages[appMeta.id]) || '';
